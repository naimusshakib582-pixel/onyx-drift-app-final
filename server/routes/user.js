...
router.get("/profile/:id", auth, async (req, res) => {
  try {
    ...
    // ✅ ফিক্স: যদি ইউজার খুঁজে না পাওয়া যায় (নতুন ইউজার হলে)
    if (!user) {
      // যদি রিকোয়েস্ট করা আইডিটি লগইন করা ইউজারের নিজের হয়, তবে একটি বেসিক প্রোফাইল তৈরি করুন
      if (targetId === req.user.sub) {
        ...
        user = savedUser.toObject(); // lean ফরম্যাটে কনভার্ট করা হলো
