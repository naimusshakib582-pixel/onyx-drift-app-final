...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col h-full py-6 justify-between bg-black/50 backdrop-blur-xl border-r border-white/5">
      ...
      {/* ১. মেইন নেভিগেশন (এখান থেকেই শুরু হবে) */}
      <div className="space-y-1">
        <p className="text-[10px] font-black text-gray-600 uppercase tracking-[0.3em] px-6 mb-6 italic opacity-50">Neural Menu</p>
        ...
        {menuItems.map((item) => (
          ...
          >
            ...
            <span className="text-[13px] font-bold tracking-wide uppercase italic">{item.name}</span>
          </NavLink>
        ))}
      </div>
      ...
      <div className="px-4 mt-auto space-y-4">
        ...
        <div className="bg-gradient-to-br from-[#111] to-black rounded-[2rem] p-5 border border-white/5 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <p className="text-[9px] font-black text-cyan-500 uppercase tracking-[0.2em] mb-1 italic">Onyx Pro</p>
            <p className="text-[11px] font-bold text-gray-400 mb-4 leading-tight">Access neural filters & advanced stats.</p>
